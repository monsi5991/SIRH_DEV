...
export const roleDashboards = {
  RH: {
    modules: ["home", "operations", "documents", "people", "resources", "analytics", "admin"],
    kpis: ["totalEmployees", "activeEmployees", "onLeave", "newHires", "pendingValidations", "upcomingBirthdays"],
    actions: [
      "createLeaveRequest",
      "createExpenseReport",
      "addEmployee",
  ...
  Manager: {
    modules: ["home", "operations", "people", "analytics"],
    kpis: ["teamSize", "teamOnLeave", "teamPendingRequests", "teamPerformance"],
    actions: ["createLeaveRequest", "createExpenseReport", "scheduleInterview", "createWorkflow"],
  },
  Employee: {
    modules: ["home", "operations_self", "people_directory"],
    kpis: ["myLeaveBalance", "myPendingRequests", "upcomingEvents"],
    actions: ["createLeaveRequest", "createExpenseReport", "uploadDocument"],
  },
};
